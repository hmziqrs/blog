...
export const GET: APIRoute = async () => {
  ...
  const lines = [
    `# ${siteConfig.name}`,
    "",
    `> ${siteConfig.blog.homeDescription} Written by ${siteConfig.author.name}. I build stuff with TypeScript, Rust, Astro, and Cloudflare. Expect opinionated takes on tooling and how I actually ship things.`,
    "",
    "## Posts",
    "",
    ...sortedPosts.map(
